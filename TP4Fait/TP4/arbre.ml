...
(*   paramètres : - une liste d'éléments (caractères dans le cas d'un dico)   *)
(*                - un arbre n-aire                                           *)
(*   résultat   : l'arbre n-aire avec la liste d'éléments                           *)
(******************************************************************************)
...
let arbre_sujet3 = retrait_arbre ['b';'a';'s'] arbre_sujet

let%test _ = not (appartient_arbre ['b';'a';'s']  arbre_sujet3)
...
(*   résultat   : La liste d'éléments qui est présente dans l'arbre                          *)
(******************************************************************************)
(*let rec parcours_arbre (Noeud (b, lb)) =
   match b,lb with
   |false, [] -> []
   |false (c,a)::q -> [c]@(parcours_arbre a)
   |true (c,a)::q -> [c]@(parcours_arbre q)*)
